...
class _NewParameterDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        form.addRow(tr("macro.field_name"), self.display_name_edit)
        form.addRow(tr("macro.field_type"), self.type_combo)
        form.addRow(tr("macro.field_default"), self.default_edit)
        form.addRow(tr("macro.field_unit"), self.unit_edit)
        form.addRow(tr("macro.field_description"), self.description_edit)
