...
class HelpWindow(QWidget):
    ...
    def __init__(self, parent=None, settings=None, language: str = "en"):
        ...
        toolbar = QHBoxLayout()
        self.btn_hide = QPushButton(tr("help.hide_contents"))
        self.btn_hide.clicked.connect(self._toggle_left_panel)
        toolbar.addWidget(self.btn_hide)
        self.btn_back = QPushButton(tr("help.back"))
        self.btn_back.clicked.connect(self._go_back)
        toolbar.addWidget(self.btn_back)
        self.btn_forward = QPushButton(tr("help.forward"))
    ...
    def navigate_to(self, topic_id: str, _record_history=True):
        ...
        self.setWindowTitle(tr("help.topic_title", title=title))
        if _record_history:
    ...
    def _toggle_left_panel(self):
        ...
        self.btn_hide.setText(tr("help.show_contents") if showing else tr("help.hide_contents"))
